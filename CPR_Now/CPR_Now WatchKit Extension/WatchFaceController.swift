...
class WatchFaceController: WKInterfaceController {

    @IBOutlet var watchFace: WKInterfaceImage!
...
//        watchFace.startAnimating()
           ...
           */
           watchFace.setImageNamed("progress")
           watchFace.startAnimatingWithImages(in: NSMakeRange(0, 100), duration: 60, repeatCount: -1)
       }
